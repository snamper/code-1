                    ...
                    s = o(
                            [
                                ...
                                function () {
                                    ...
                                    var eleStr = i.check && i.check == "checkbox" ? '<input type="checkbox" name="' + i.checkboxName + '" ' + ((n.checked && n.checked == true) ? 'checked="checked"' : "") + (n.checkboxValue ? ('value="' + n.checkboxValue + '"') : "") + 'data-parent-id="' + n.pid + '"' + 'data-code="' + n.code + '"'+'data-type="' + n.type + '"'+ 'id="' + n.id + '"' + (i.checkboxStyle ? (' style="' + i.checkboxStyle + '"') : "") : '';
                                    if (eleStr.length > 0) {
                                        //给元素添加data-xxx属性
                                        if (n.data && Object.prototype.toString.call(n.data) == "[object Object]") {
            ...
            if (o.pid == undefined || o.pid == null) {
                e.children("input").on("change", function () {
                    var childUl = e.children("ul"),
                        ...
                        childUl.find("input").attr("checked", checked);
                ...
                e.children("input").on("change", function () {
                    ...
                    if (!this.checked) {
                        if (o.children && o.children.length > 0) {
                            ...
                            childUl.find("input").attr("checked", false);
                            childUl.find("input").prop("checked", false);
                        }
...
//                  r.click(o)
//          })
            e.children("input").on("click", function (e) {
                layui.stope(e),
                    r.click(o)
            })
        },
