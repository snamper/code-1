...
//	var $selType = $('.selectBtnF').attr('data-selType')||'2';
	$('.selectBtnF').attr('data-selType','3');
	var $selType = $('.selectBtnF').attr('data-selType')||'3';
	$('.selectBtnF').on('click', function (){//选择轮播图链接
		...
		layer.open({
			...
			content: '<div id="secleUrl">' +
					...
					'</div>' + 
					'<div class="layui-tab tabChange flex-tabChange" data-selType="3">' +
						'<ul class="layui-tab-title tabLis" id="tabLis">' +
//							'<li data-linkType="2" class="layui-this">广告</li>' +
							'<li data-linkType="3" class="layui-this">商品</li>' +
						'</ul>' +
					'</div>' +
