...
layui.use(['element', 'form'], function() {
	...
	var cateMessage = JSON.parse($(".cateSection").attr("data-message"));
	var cateType = cateMessage.sortType,		//分类类型
		firstCate = cateMessage.fid,		//一级分类id
		status = cateMessage.status;
	if(!firstCate) firstCate = "";
	//分类类型
