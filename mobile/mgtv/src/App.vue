<template>
  <div id="app">
    ...
    <div class='from-group'>
      ...
      <button class='submit-btn submit-btn-on' :disabled="submitBtn?false:'disabled'" @click="submitRegister">立即领取</button>
      <div class='tip-msg'>{{popInfo ? tipMsg:''}}</div>
    </div>
    <!--<img src="./assets/hot_exchange.png" class='fontImg' alt="">
    <img src="./assets/all_people.png" class='bannerImg' alt="">-->
    	<img src="./assets/foot1.png" class="footimg" alt=""/>
    <van-popup class='popWrap' v-model='pop'>
      <p class="popTitle">{{popInfo ? "恭喜你":"温馨提示"}}</p>
      <div class='popContent'>
        {{popInfo ? "领取优惠券成功!":tipMsg}}
      </div>
      <div class='popBtn'>
