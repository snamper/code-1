...
const Index = ({checkPendingGoods,loading,dispatch,location})=>{
  return (
    <div>
      <Form 
      layout="inline" 
      ...
      <div className={styles.btnGroup}>
        <Button className={styles.left} type="primary">全部</Button>
        <Button className={styles.left}>待审核</Button>
        <Button className={styles.left}>审核未通过</Button>
        <Button className={styles.right} type="primary">批量审核</Button>
...
export default connect(({checkPendingGoods,account,loading})=>({account,loading}))(Form.create()(Index));
