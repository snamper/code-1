  ...
  <div class="good_detail">
   ...
   <div class="good_detail_content">
      ...
      <div class="purchaseBox">
        <h4>购买须知：</h4>
        <!-- <div class="purchaseBoxDetail" v-html="dataListInfo">
        </div> -->
        <div class="Dteail" v-for="(item,index) in proExtends" :key="item.id">
      ...
      <div class="footerPayBox">
        <div class="payInfoBox" v-show="bottomStatus">
          ...
          <router-link v-if="goodsStock" :to="{path:'/order/confirmOrder',query:{id:productId}}"><span class="payBtn" :class="{payBtnBg: goodsStock}">立即购买</span></router-link>
